        ...
        <>
            ...
            <div className="grid-container grid md:grid-cols-3 gap-2 m-2">
                <div className="grid-boxes min-h-96 border-gray-400 rounded-2xl md:col-span-2 p-5">
                    <h2 className={`text-orange-600 text-3xl abt transition-opacity duration-1000 ${isTextVisible ? "opacity-100": "opacity-0"}`}>About me</h2>
                    <p className={`mt-10 transition-opacity duration-1000 ${isTextVisible ? "opacity-100": "opacity-0"}`}>I am a Qualified Chartered Accountant having experience with working at BDO India in the statutory audit of BFSI sector and KPMG in the audit of Private Equity Funds, Mutual Funds and Hedge Funds. Currently, working as finance professional at 
